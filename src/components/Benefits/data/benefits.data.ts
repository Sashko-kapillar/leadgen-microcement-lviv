...
export const benefitsSectionData: BenefitsSectionData = {
  ...
  cta: {
    title: 'Головний тренд сучасних інтер’єрів',
    text: 'Мікроцемент поєднує сучасний вигляд, практичність і свободу дизайну — рішення, яке не втратить актуальності з часом.',
